...
Source: "data_epargne.db"; DestDir: "{app}"; Flags: ignoreversion onlyifdoesntexist
...
Name: "{userstartup}\Mon Logiciel d'Épargne"; Filename: "{app}\form1.exe"; IconFilename: "{app}\money.ico"
